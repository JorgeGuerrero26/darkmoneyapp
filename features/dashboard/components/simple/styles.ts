...
export const dashboardSimpleStyles = StyleSheet.create({
  ...
  upcomingMetaRow: {
    ...
    paddingTop: SPACING.md,
    borderTopWidth: 1,
    borderTopColor: "rgba(244,241,236,0.06)",
  },
  ...
  aiSummaryAmbientGlowCoral: {
    bottom: -20,
    right: -10,
    backgroundColor: "rgba(226,160,126,0.08)",
  },
  ...
  explanationVisualTrack: {
    height: 5,
    borderRadius: RADIUS.full,
    backgroundColor: "rgba(244,241,236,0.09)",
    overflow: "hidden",
  },
  ...
  explanationSectionCard: {
    ...
    borderWidth: 1,
    borderColor: "rgba(244,241,236,0.075)",
    gap: SPACING.md,
  },
  ...
  explanationBulletDotMuted: {
    ...
    borderRadius: 3,
    marginTop: 8,
    backgroundColor: "rgba(244,241,236,0.42)",
  },
  ...
  explanationActionsSection: {
    ...
    borderTopWidth: 1,
    borderTopColor: "rgba(244,241,236,0.09)",
    gap: SPACING.md,
  },
  ...
  resultMeaningCardWarning: {
    ...
    borderColor: "rgba(217,182,92,0.22)",
  },
  ...
  panelCoachCard: {
    ...
    borderWidth: 1,
    borderColor: "rgba(217,182,92,0.24)",
    gap: SPACING.sm,
  ...
  panelCoachIcon: {
    ...
    alignItems: "center",
    justifyContent: "center",
    backgroundColor: "rgba(217,182,92,0.14)",
  },
  ...
  panelApplyBtn: {
    ...
    paddingVertical: SPACING.sm,
    borderRadius: RADIUS.full,
    backgroundColor: "rgba(217,182,92,0.24)",
  },
  panelApplyBtnText: {
    fontFamily: FONT_FAMILY.bodySemibold,
    fontSize: FONT_SIZE.sm,
  ...
  annualBarsBox: {
    ...
    gap: 2,
    borderRadius: RADIUS.md,
    backgroundColor: "rgba(244,241,236,0.035)",
    paddingHorizontal: 2,
    paddingBottom: 2,
  },
  annualFlowBar: {
  ...
  netBarsAxis: {
    ...
    top: 34,
    height: 1,
    backgroundColor: "rgba(244,241,236,0.14)",
  },
  netBar: {
    position: "absolute",
    left: "24%",
  ...
  anomalyCardReview: { backgroundColor: "rgba(37,31,19,0.96)", borderColor: "rgba(217,182,92,0.20)" },
  ...
  proGate: {
    ...
    paddingVertical: SPACING.lg,
    paddingHorizontal: SPACING.lg,
    backgroundColor: "rgba(217,182,92,0.06)",
    borderRadius: RADIUS.lg,
    borderWidth: 1,
    borderColor: "rgba(217,182,92,0.18)",
  },
  proGateHeader: {
    flexDirection: "row",
    alignItems: "flex-start",
  ...
  proGateIconWrap: {
    ...
    height: 32,
    borderRadius: RADIUS.full,
    backgroundColor: "rgba(217,182,92,0.10)",
    alignItems: "center",
    justifyContent: "center",
  },
  proGateIconWrapLg: {
  ...
  proGateFeatures: {
    ...
    paddingTop: SPACING.sm,
    borderTopWidth: 1,
    borderTopColor: "rgba(217,182,92,0.10)",
  },
  proGateFeatureRow: {
    flexDirection: "row",
    alignItems: "center",
  ...
  advancedGiftPill: {
    ...
    paddingVertical: 8,
    borderRadius: RADIUS.full,
    backgroundColor: "rgba(244,241,236,0.16)",
    borderWidth: 1,
    borderColor: "rgba(244,241,236,0.26)",
  },
