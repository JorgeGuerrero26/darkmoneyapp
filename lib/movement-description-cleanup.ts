...
const MERCHANT_PATTERNS: Array<{ pattern: RegExp; description: string; reason: string }> = [
  ...
  { pattern: /\b(rest|restaurant|restaurante|polleria|cevicheria|chifa|pizzeria|comida|delivery)\b/i, description: "Comida fuera de casa", reason: "detectamos comercio de comida" },
  ...
  { pattern: /\b(taxi|uber|cabify|didi|indriver|movilidad)\b/i, description: "Pago de movilidad", reason: "detectamos servicio de movilidad" },
  { pattern: /\b(market|supermercado|tambo|oxxo|mass|plaza vea|metro|wong|vivanda)\b/i, description: "Compra en tienda", reason: "detectamos comercio de tienda" },
  { pattern: /\b(luz|agua|internet|claro|movistar|win|calidda|bitel|entel)\b/i, description: "Pago de servicio", reason: "detectamos pago de servicio" },
];
