...
class DarkMoneyNotificationListenerService : NotificationListenerService() {
  ...
  // Parsing de montos extraído a AmountParsing (objeto puro, testeable con JUnit).
  private fun extractAmount(value: String): String? = AmountParsing.extractAmount(value)
