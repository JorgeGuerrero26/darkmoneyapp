 ...
 * `variant="row"` (o `variant="line"`, su forma sin ícono ni cápsula de la revisión 25),
 * `ResourceCard` pinta fondo, borde y esquinas, y la lista vuelve a leerse como una pila de
 * bloques sueltos.
 *
...
describe("las listas se dibujan como filas, no como tarjetas", () => {
  ...
  it("ningun ResourceCard de lista se queda sin variant de fila", () => {
