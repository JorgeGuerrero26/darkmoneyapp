...
const styles = StyleSheet.create({
  ...
  filterSheetTitle: { fontSize: FONT_SIZE.md, fontWeight: FONT_WEIGHT.bold, color: COLORS.text, textAlign: "center" },
  filterSectionLabel: { fontSize: FONT_SIZE.xs, fontWeight: FONT_WEIGHT.semibold, color: COLORS.textMuted, textTransform: "uppercase", letterSpacing: 0.5 },
  ...
  applyBtnText: { color: "#FFF", fontSize: FONT_SIZE.md, fontWeight: FONT_WEIGHT.semibold },
});
