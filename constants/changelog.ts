...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    changes: [
      ...
      "Bajar por Movimientos vuelve a ser por tandas. La lista pedía los siguientes cuando todavía te faltaban dos pantallas por recorrer, y como cada tanda dejaba el final igual de cerca, se cargaba entera sola sin que hubieras llegado abajo. Ahora pide más cuando de verdad te acercas al final, y las filas dejaron de deslizarse cada vez que asoman: el scroll ya no da tirones.",
