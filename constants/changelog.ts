...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    changes: [
      ...
      "Los atajos del inicio bajan dentro de \"Resumen\", que es donde caes al abrir. Antes estaban entre el título y las pestañas, empujándolas hacia abajo y pareciendo que eran un filtro de ellas. En Patrones o Flujo ya no salen: cuando estás analizando no estás anotando.",
      "Y ocupan la cuarta parte: se fue el rótulo \"LO DE SIEMPRE\", porque un botón que dice \"Moto S/ 4.00\" ya se explica solo. Son tres recuadros del mismo ancho que nunca se cortan por el borde, y si tienes más de tres, el tercero abre la lista completa.",
      "Al tocar uno, el movimiento queda anotado y el aviso te dice qué se anotó, cuánto y de qué cuenta salió, con Deshacer. Las cifras de arriba cambian en el acto, así que se ve que funcionó.",
      ...
      "Y en esa bandeja, si tienes Pro, la IA propone las que a la app no le da el historial para adivinar: comercios que solo aparecieron una o dos veces. Va en tanda —una sola consulta para hasta 25 grupos, no una por cada uno— y las propuestas de la IA se ven distintas de las tuyas, en su color, porque una es una opinión y la otra sale de lo que ya clasificaste.",
      ...
      "Arreglado: en Presupuestos, si todos los tuyos ya terminaron su período, la pantalla decía \"están fuera de este filtro\" y ofrecía limpiar filtros — sin que hubiera ninguno puesto, así que el botón no hacía nada. Ahora te dice que terminaron, cuándo cerró el último, y el botón te los muestra.",
      "Presupuestos deja de contarte mal. Si tienes el mismo presupuesto varios meses seguidos, la app los trataba como presupuestos distintos: salían tres filas de \"Alimentación\" y arriba sumaba los tres meses — \"S/ 1,752.32 de S/ 1,200.00\", un límite de 1,200 que nunca existió, y un exceso que no te pasó en ningún mes.",
      "Ahora es una fila por presupuesto con el mes en curso, y los meses cerrados van juntos abajo, resumidos: \"Te pasaste en 2 de los 3 últimos meses\". El total de arriba suma solo lo que corre a la vez, y si te pasaste te dice en cuál: el margen que te sobra en transporte no compensa lo que te pasaste en comida.",
      "Cada fila dice el estado una vez, no cuatro. Se fueron la etiqueta, el aviso con triángulo y el \"tocar para editar\", y queda lo que ayuda: cuánto te pasaste y cuántos días faltan. El amarillo de \"cerca del límite\" también se fue — no es un problema ir al 81% cuando quedan 22 días.",
      "Y la barra ahora marca por dónde deberías ir a estas alturas del mes. Es lo que convierte un 81% en información: el día 8 es alarmante, el día 26 es normal.",
      "Y crear un presupuesto ya no es crear un mes. Antes elegías \"este mes\" o \"el próximo\", y en octubre había que crearlo otra vez — por eso te salían tres \"Alimentación\" apiladas. Ahora eliges cada cuánto se renueva y la app abre el período nuevo sola. Para un viaje o algo que termina, \"Entre dos fechas\" sigue ahí.",
      "Dividir un gasto entre categorías ahora te dice cuánto falta por repartir. Antes escribías dos montos a ciegas: si el gasto era de S/ 86.40 y ponías 62.40, nada te decía que quedaban 24 — había que restar de cabeza. Ahora se ve el resto, y el segundo renglón te llega propuesto con lo que sobra: lo tocas y ya está.",
      "Y se abre en su propia pantalla, en vez de crecer dentro del formulario. Antes había dos aspas casi pegadas, una para cerrar y otra para descartar la división, y dos listas que se desplazaban una dentro de otra.",
      "Cada parte se llama por su categoría —\"los 62.40 de Alimentación\"— en vez de \"Parte 1\" y \"Parte 2\", que no significaban nada y se renumeraban al borrar una.",
      "También se pueden dividir los ingresos: parte venta, parte reembolso. En una transferencia no aparece, porque mover plata entre tus cuentas no tiene categoría.",
      "Y una línea aclara lo que nadie decía: sigue siendo un solo movimiento en tu cuenta. El reparto es solo para los presupuestos y los informes.",
      "Lo primero que te pregunta es qué limitas, y ya no viene puesto en \"Todas\": un presupuesto llamado \"Alimentación\" que en realidad contaba gasolina y alquiler era un error fácil de cometer y difícil de notar.",
      "El nombre se propone solo con lo que elegiste, así que no tienes que inventarlo antes de empezar; se cambia en \"Opcionales\". Y \"Arrastrar saldo al siguiente período\" —que necesitaba cinco líneas de explicación— ahora se llama \"Guardar lo que sobre\".",
      "Y al abrir un presupuesto ya no te felicita por un mes vacío. Si el mes cerró sin que anotaras nada, salía \"0% · En rango\" en verde y grande — como si te hubieras portado bien, cuando lo que pasó es que no se registró nada. Ahora te lo dice: \"Junio cerró sin movimientos\", con un botón para ir a revisarlos.",
      "Los meses anteriores suben a lo alto de la pantalla, uno debajo de otro con su barra, y la app saca la conclusión: \"Te pasaste en 2 de los 3 últimos meses. El límite de S/ 400 puede estar corto\". Un presupuesto se juzga por la racha, no por un mes suelto — y ese dato estaba enterrado al final en letra chica.",
      "Arriba quedan las dos cifras que se leen juntas, \"S/ 322.12 de S/ 400.00\", y una frase que dice cuánto te queda y para cuántos días alcanza. Se fue el recuadro con cuatro números donde uno era la resta de los otros dos.",
      "Arreglado también un cálculo mío: la marca del ritmo no contaba el día de hoy, así que el 8 de septiembre decía que se esperaban S/ 96.55 cuando son S/ 107.",
      "Al abrir un ingreso fijo ahora ves los sueldos que faltan por confirmar. La pantalla decía \"Activo\" en verde justo encima de una fecha vencida hace 39 días, y el historial contaba solo lo que habías anotado: los dos sueldos que nadie confirmó —S/ 5,261— no salían por ninguna parte. Ahora arriba dice \"2 sin confirmar\" con las fechas y el monto, y esas dos llegadas aparecen en la lista para anotarlas.",
      "Se anotan en orden, de la más antigua a la más reciente. Es lo que evita que al confirmar la de agosto se pierda la de julio.",
      "El botón dice cuál: \"Anotar las 2 llegadas\" en vez de \"Marcar recibido\", que con dos pendientes no decía nada. Pausar se mudó al menú de tres puntos, con su nombre, y se fue \"Análisis\", que estaba dos veces en la misma pantalla.",
      "En el historial, cada llegada dice en palabras cuánto se adelantó o se atrasó —\"Llegó 3 días antes\"— en vez de una etiqueta de color; un día de diferencia salía en ámbar como si fuera un problema. Y en el sitio que ocupaba esa etiqueta ahora ves algo que no estaba: si ese mes te llegó de más o de menos.",
      "Los datos del ingreso se leen de arriba abajo, en filas, en vez de una cuadrícula que había que leer en zigzag. Y \"Quién paga\" se elige tocándolo, sin entrar a editar.",
      "Anotar una llegada es ahora un toque. La hoja preguntaba cuatro cosas —fecha, monto, cuenta y si el monto cambia para siempre— y todas venían ya contestadas: confirmar un sueldo que llegó como se esperaba obligaba a revisar cuatro campos para no tocar ninguno. Ahora te dice lo que va a hacer —\"Se anota como ingreso en Cuenta Sueldo, con fecha 29 jul\"— y te da el botón.",
      "Si llegó distinto, se toca \"Llegó distinto\" y ahí cambias monto, fecha o cuenta. Al cambiar el monto te dice cuánto se aparta de lo esperado: \"S/ 149.50 más que lo esperado\".",
      "Y la pregunta de si el cambio es para siempre se hace en cristiano: \"¿Es así de ahora en adelante?\" · Solo esta vez / Desde ahora. Antes había que elegir entre \"Bonificación\" y \"Descuento\", que nombran el motivo y no lo que hacen — y una bonificación es justo lo contrario de permanente. Ya no te pide escribir otra vez el monto nuevo: es el que acabas de poner.",
      "Los montos escritos en un campo ahora llevan separador de miles cuando no los estás editando: \"2,630.50\" en vez de \"2630.5\" al lado de la misma cifra bien escrita.",
